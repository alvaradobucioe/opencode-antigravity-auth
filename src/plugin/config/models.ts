...
export const OPENCODE_MODEL_DEFINITIONS: OpencodeModelDefinitions = {
  ...
  "gemini-3.1-flash-lite": buildModelDefinition("gemini-3.1-flash-lite", "Gemini 3.1 Flash Lite"),
  ...
  "antigravity-gemini-3.1-flash-lite": buildModelDefinition("antigravity-gemini-3.1-flash-lite", "Gemini 3.1 Flash Lite (Antigravity)"),
