...
export const OPENCODE_MODEL_DEFINITIONS: OpencodeModelDefinitions = {
  ...
  "tab_flash_lite_preview": buildModelDefinition("tab_flash_lite_preview", "Tab Flash Lite Preview (Antigravity)"),
  ...
  "gemini-3-flash-preview": buildModelDefinition("gemini-3-flash-preview", "Gemini 3 Flash Preview"),
  "gemini-3-pro-preview": buildModelDefinition("gemini-3-pro-preview", "Gemini 3 Pro Preview"),
  "gemini-3.1-pro-preview": buildModelDefinition("gemini-3.1-pro-preview", "Gemini 3.1 Pro Preview"),
  "gemini-3.1-pro-preview-customtools": buildModelDefinition("gemini-3.1-pro-preview-customtools", "Gemini 3.1 Pro Preview Custom Tools"),
};
